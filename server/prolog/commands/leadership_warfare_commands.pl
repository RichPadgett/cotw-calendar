...
% -----------------------------------------------------------------------------
% Additional Leadership And Warfare Review Commands
% -----------------------------------------------------------------------------
...
study_note(appoint_a_king_only_as_torah_allows, 'TODO: Verify wording against the written Torah text before final catalog refinement.').
...
study_note(do_not_appoint_a_foreigner_as_king_over_israel, 'TODO: Verify wording against the written Torah text before final catalog refinement.').
...
study_note(king_must_not_multiply_horses, 'TODO: Verify wording against the written Torah text before final catalog refinement.').
...
study_note(king_must_not_cause_the_people_to_return_to_egypt_for_horses, 'TODO: Verify wording against the written Torah text before final catalog refinement.').
...
study_note(king_must_not_multiply_wives, 'TODO: Verify wording against the written Torah text before final catalog refinement.').
...
study_note(king_must_not_greatly_multiply_silver_and_gold, 'TODO: Verify wording against the written Torah text before final catalog refinement.').
...
study_note(king_must_write_a_torah_copy, 'TODO: Verify wording against the written Torah text before final catalog refinement.').
...
study_note(king_must_read_torah_all_his_days, 'TODO: Verify wording against the written Torah text before final catalog refinement.').
...
study_note(offer_peace_to_a_city_before_fighting, 'TODO: Verify wording against the written Torah text before final catalog refinement.').
...
study_note(exempt_from_battle_the_man_with_new_house_vineyard_betrothal_or_fear, 'TODO: Verify wording against the written Torah text before final catalog refinement.').
...
study_note(do_not_fear_enemies_in_battle_when_priest_gives_the_torah_exhortation, 'TODO: Verify wording against the written Torah text before final catalog refinement.').
...
study_note(do_not_destroy_fruit_trees_in_siege, 'TODO: Verify wording against the written Torah text before final catalog refinement.').
...
study_note(keep_the_war_camp_clean, 'TODO: Verify wording against the written Torah text before final catalog refinement.').
...
study_note(designate_a_place_outside_the_camp, 'TODO: Verify wording against the written Torah text before final catalog refinement.').
...
study_note(carry_a_digging_tool_with_your_equipment_and_cover_excrement, 'TODO: Verify wording against the written Torah text before final catalog refinement.').
